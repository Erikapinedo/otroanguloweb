  ...
  var STRINGS = {
    es: {
      ...
      playersnapProjectPage: {
        ...
        heroSub: 'Diseño UX/UI end-to-end',
        contextTitleHtml: '<strong class="bold-text-4">Del caos de </strong><strong class="bold-text-9">archivos</strong><strong class="bold-text-4"> a distribución en tiempo real</strong>',
        ...
        ctxMetaRolLabel: 'Rol',
        ctxMetaRolValue: 'Diseñadora UX/UI',
        ctxMetaTypeLabel: 'Tipo de proyecto',
        ctxMetaTypeValue: 'SaaS B2B · Diseño de producto',
        ctxMetaDurationLabel: 'Duración',
        ctxMetaDurationValue: '3 meses',
        ctxMetaToolsLabel: 'Herramientas',
        ctxMetaToolsValue: 'Figma · FigJam · Notion',
        barRolLabel: 'Rol',
        barRolValue: 'Diseñadora UX/UI',
        barDurationLabel: 'Duración',
        barDurationValue: '3 meses',
        barToolsLabel: 'Herramientas',
        barToolsValue: 'Figma · FigJam',
        barTypeLabel: 'Tipo',
        barTypeValue: 'SaaS B2B',
        problemH: 'El Desafío',
        ...
        prob4Title: 'Sin métricas de rendimiento',
        prob4Body: 'La falta de analytics sobre qué contenido funciona mejor impedía tomar decisiones informadas sobre estrategia de contenido y maximizar el impacto.',
        ...
        sol1Html: '<strong class="text-solution-parrotfy">Etiquetado IA</strong><br/>Reconocimiento automático de jugadores, equipos y eventos para clasificar el contenido sin esfuerzo manual.',
        sol2Html: '<strong class="text-solution-parrotfy">Búsqueda avanzada</strong><br/>Filtros multidimensionales por jugador, equipo, evento, fecha y tipo de contenido para encontrar cualquier activo al instante.',
        sol3Html: '<strong class="text-solution-parrotfy">Distribución en tiempo real</strong><br/>Comparte contenido directamente con socios de medios y plataformas sociales desde la misma plataforma.',
        sol4Html: '<strong class="text-solution-parrotfy">Analytics de rendimiento</strong><br/>Métricas de engagement y uso que ayudan a entender qué contenido conecta mejor con los fans.',
        sol5Html: '<strong class="text-solution-parrotfy">Gestión multicanal</strong><br/>Un hub central para gestionar y distribuir activos hacia múltiples destinos simultáneamente.',
        sol6Html: '<strong class="text-solution-parrotfy">Acceso por roles</strong><br/>Control granular de permisos para que cada miembro del equipo acceda solo al contenido y herramientas que necesita.',
        impactH: 'Impacto',
        ...
        imp1Html: '<strong>Más engagement</strong><br/>Contenido distribuido en el momento preciso que los fans lo esperan, maximizando el impacto.',
        imp2Html: '<strong>Ahorro de tiempo</strong><br/>El etiquetado automático elimina horas de trabajo manual por semana.',
        imp3Html: '<strong>Mejor organización</strong><br/>Todos los activos multimedia en un solo lugar, clasificados y listos para usar.',
        imp4Html: '<strong>Decisiones basadas en datos</strong><br/>Analytics claros sobre qué contenido funciona mejor para optimizar la estrategia.',
        imp5Html: '<strong>Distribución escalable</strong><br/>Un sistema que crece con la organización sin perder velocidad ni calidad.',
    ...
    en: {
      ...
      playersnapProjectPage: {
        ...
        heroSub: 'End-to-end UX/UI design',
        contextTitleHtml: '<strong class="bold-text-4">From file </strong><strong class="bold-text-9">chaos</strong><strong class="bold-text-4"> to real-time distribution</strong>',
        ...
        ctxMetaRolLabel: 'Role',
        ctxMetaRolValue: 'UX/UI Designer',
        ctxMetaTypeLabel: 'Project type',
        ctxMetaTypeValue: 'SaaS B2B · Product design',
        ctxMetaDurationLabel: 'Duration',
        ctxMetaDurationValue: '3 months',
        ctxMetaToolsLabel: 'Tools',
        ctxMetaToolsValue: 'Figma · FigJam · Notion',
        barRolLabel: 'Role',
        barRolValue: 'UX/UI Designer',
        barDurationLabel: 'Duration',
        barDurationValue: '3 months',
        barToolsLabel: 'Tools',
        barToolsValue: 'Figma · FigJam',
        barTypeLabel: 'Type',
        barTypeValue: 'SaaS B2B',
        ...
        prob4Title: 'No performance metrics',
        prob4Body: 'The lack of analytics on which content performs best prevented informed decisions about content strategy and maximizing impact.',
        ...
        sol1Html: '<strong class="text-solution-parrotfy">AI Tagging</strong><br/>Automatic recognition of players, teams, and events to classify content without manual effort.',
        sol2Html: '<strong class="text-solution-parrotfy">Advanced Search</strong><br/>Multi-dimensional filters by player, team, event, date, and content type to find any asset instantly.',
        sol3Html: '<strong class="text-solution-parrotfy">Real-time Distribution</strong><br/>Share content directly with media partners and social platforms from within the platform.',
        sol4Html: '<strong class="text-solution-parrotfy">Performance Analytics</strong><br/>Engagement and usage metrics that help understand what content resonates best with fans.',
        sol5Html: '<strong class="text-solution-parrotfy">Multichannel Management</strong><br/>A central hub to manage and distribute assets to multiple destinations simultaneously.',
        sol6Html: '<strong class="text-solution-parrotfy">Role-based Access</strong><br/>Granular permission control so each team member accesses only the content and tools they need.',
        impactH: 'Impact',
        ...
        imp1Html: '<strong>More engagement</strong><br/>Content distributed at the precise moment fans expect it, maximizing impact.',
        imp2Html: '<strong>Time savings</strong><br/>Automatic tagging eliminates hours of manual work per week.',
        imp3Html: '<strong>Better organization</strong><br/>All media assets in one place, classified and ready to use.',
        imp4Html: '<strong>Data-driven decisions</strong><br/>Clear analytics on which content performs best to optimize strategy.',
        imp5Html: '<strong>Scalable distribution</strong><br/>A system that grows with the organization without losing speed or quality.',
