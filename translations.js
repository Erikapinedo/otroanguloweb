  ...
  var STRINGS = {
    es: {
      ...
      portfolioPage: {
        ...
        "matchmindersDesc": "Mapeo de flujos, diseño de interfaces y construcción del Design System para una plataforma que permite crear y gestionar torneos deportivos presenciales y online.<br/>",
      ...
      bluesphereProjectPage: {
        ...
        contextBody: 'BlueSphere es una plataforma de resiliencia operativa nativa en la nube, impulsada por IA, que integra seguridad, gobernanza y rendimiento en un único sistema diseñado para pymes. A través de tres productos —Shield, Fabric y Pulse— entrega protección enterprise sin la complejidad ni los costos que antes solo las grandes empresas podían pagar.',
        ...
        impactFinalHtml: '<strong class="bold-text-11">Protege más. Preocúpate menos. Crece con confianza.</strong>',
        ...
        brandbookIntro: 'Antes de diseñar la plataforma, construimos la identidad visual completa de BlueSphere desde cero. El brandbook fue el punto de partida: definió la marca, el logo, la paleta cromática y la tipografía que dan coherencia a toda la experiencia de producto.',
      ...
      matchmindersProjectPage: {
        ...
        heroSub: 'Diseño UX/UI · Mapeo de Flujos · Design System',
        startLabel: 'Inicio',
        teamLabel: 'Equipo',
        teamDesc: '1 diseñadora UX/UI, equipo de desarrollo',
        roleLabel: 'Rol',
        roleValue: 'Diseñadora UX/UI',
        contextTitleHtml: 'Una idea clara. <em>Flujos y diseño</em> por construir.',
        contextBody: 'MatchMinders es una plataforma innovadora para crear, gestionar y participar en torneos de deportes favoritos — desde fútbol y tenis hasta e-sports y más. El equipo llegó con una visión clara del producto, pero sin flujos definidos ni sistema de diseño que pudiera guiar el desarrollo hacia una experiencia consistente y escalable.',
        ...
        problemH: 'El Desafío',
        problemBodyHtml: 'El equipo tenía la idea y la motivación, pero necesitaba traducir esa visión en una experiencia de usuario concreta y coherente. Los desafíos eran múltiples y urgentes.<br/><br/><strong>El reto fue organizar y diseñar toda la experiencia para dos perfiles con necesidades radicalmente distintas: el Organizador y el Jugador.</strong>',
        prob1Title: 'Sin flujos definidos',
        prob1Body: 'Cada función existía como idea, pero sin un mapa claro de cómo se conectaban entre sí, generando riesgo de inconsistencias durante el desarrollo.',
        prob2Title: 'Dos perfiles muy distintos',
        prob2Body: 'Organizadores y jugadores tienen objetivos radicalmente diferentes, requiriendo flujos y experiencias diseñadas de forma independiente para cada perfil.',
        prob3Title: 'Sin Design System',
        prob3Body: 'Sin una biblioteca de componentes ni tokens definidos, cada pantalla se construiría desde cero, sin coherencia visual ni consistencia de comportamiento.',
        prob4Title: 'Complejidad operativa',
        prob4Body: 'La gestión de torneos implica inscripciones, pagos, rankings y comunicaciones — todo integrado en una sola experiencia fluida y sin fricciones.',
        ...
        approachH: 'El Enfoque',
        approachBodyHtml: 'Se priorizó mapear los flujos completos de ambos perfiles antes de diseñar ninguna pantalla, para asegurar coherencia en toda la experiencia.',
        approachBody2: 'El diseño se estructuró en tres pilares:',
        approach1Title: 'Mapear antes de diseñar',
        approach1Body: 'Definir los flujos completos para Organizador y Jugador antes de diseñar ninguna pantalla, para asegurar coherencia y reducir re-trabajo.',
        approach2Title: 'Sistema desde la base',
        approach2Body: 'Construir el Design System en paralelo con las interfaces, asegurando que cada componente sea reutilizable, consistente y escalable desde el primer día.',
        approach3Title: 'Diseñar para dos audiencias',
        approach3Body: 'Adaptar la experiencia a los objetivos específicos de cada perfil, sin perder la cohesión visual y funcional de la plataforma.',
        solutionH: 'La Solución',
        ...
        impactH: 'Impacto',
        impactBodyHtml: '<strong>MatchMinders pasó de una idea a una plataforma con flujos claros, interfaces definidas y un sistema de diseño escalable listo para guiar el desarrollo.</strong>',
        imp1Html: '<strong>Flujos organizados</strong>Experiencias claras y diferenciadas para Organizador y Jugador.',
        imp2Html: '<strong>Design System funcional</strong>Componentes reutilizables y tokens definidos que aseguran coherencia en toda la plataforma.',
        imp3Html: '<strong>Base para el desarrollo</strong>El equipo técnico contó con una guía visual y funcional clara para construir la plataforma.',
        imp4Html: '<strong>Plataforma escalable</strong>Un sistema diseñado para crecer con nuevos deportes, formatos y funcionalidades.',
        impactFinalHtml: '<strong>De la idea a la pantalla: flujos, interfaces y sistema de diseño que convierten una visión en un producto real.</strong>',
    ...
    en: {
      ...
      portfolioPage: {
        ...
        "matchmindersDesc": "Flow mapping, interface design, and Design System built from scratch for a platform to create and manage in-person and online sports tournaments.<br/>",
      ...
      bluesphereProjectPage: {
        ...
        contextBody: 'BlueSphere is an AI-enabled, cloud-native operational resilience platform that integrates security, governance, and performance into a single system built for SMBs. Through three focused products — Shield, Fabric, and Pulse — it delivers enterprise-grade protection without the complexity or cost that only large corporations could afford.',
        ...
        impactFinalHtml: '<strong class="bold-text-11">Protect More. Stress Less. Grow with confidence.</strong>',
        ...
        brandbookH: 'Brandbook',
        brandbookIntro: 'Before designing the platform, we built BlueSphere\'s complete visual identity from scratch. The brandbook was the starting point: it defined the brand, logo, color palette, and typography that give coherence to the entire product experience.',
      ...
      matchmindersProjectPage: {
        ...
        heroSub: 'UX/UI Design · Flow Mapping · Design System',
        startLabel: 'Start',
        teamLabel: 'Team',
        teamDesc: '1 UX/UI designer, development team',
        roleLabel: 'Role',
        roleValue: 'UX/UI Designer',
        contextTitleHtml: 'A clear idea. <em>Flows and design</em> yet to be built.',
        contextBody: 'MatchMinders is an innovative platform to create, manage, and participate in favorite sports tournaments — from football and tennis to e-sports and more. The team came with a clear product vision but without defined flows or a design system to guide development toward a consistent, scalable experience.',
        ...
        problemH: 'The Challenge',
        problemBodyHtml: 'The team had the idea and the motivation, but needed to translate that vision into a concrete and coherent user experience. The challenges were multiple and urgent.<br/><br/><strong>The challenge was to organize and design the full experience for two profiles with radically different needs: the Organizer and the Player.</strong>',
        prob1Title: 'No defined flows',
        prob1Body: 'Each feature existed as an idea, but without a clear map of how they connected, creating a risk of inconsistencies during development.',
        prob2Title: 'Two very different profiles',
        prob2Body: 'Organizers and players have radically different goals, requiring independently designed flows and experiences for each profile.',
        prob3Title: 'No Design System',
        prob3Body: 'Without a component library or defined tokens, every screen would be built from scratch, with no visual coherence or behavioral consistency.',
        prob4Title: 'Operational complexity',
        prob4Body: 'Tournament management involves registrations, payments, rankings, and communications — all integrated into a seamless, frictionless experience.',
        flowsH: 'User Flows',
        ...
        approachH: 'The Approach',
        approachBodyHtml: 'Full flow mapping for both profiles was prioritized before designing any screen, to ensure coherence throughout the experience.',
        approachBody2: 'The design was structured around three pillars:',
        approach1Title: 'Map before designing',
        approach1Body: 'Define complete flows for Organizer and Player before designing any screen, to ensure coherence and reduce rework.',
        approach2Title: 'System from the ground up',
        approach2Body: 'Build the Design System in parallel with the interfaces, ensuring every component is reusable, consistent, and scalable from day one.',
        approach3Title: 'Design for two audiences',
        approach3Body: 'Tailor the experience to the specific goals of each profile, without losing the visual and functional cohesion of the platform.',
        solutionH: 'The Solution',
        ...
        impactH: 'Impact',
        impactBodyHtml: '<strong>MatchMinders went from an idea to a platform with clear flows, defined interfaces, and a scalable design system ready to guide development.</strong>',
        imp1Html: '<strong>Organized flows</strong>Clear and differentiated experiences for Organizer and Player.',
        imp2Html: '<strong>Functional Design System</strong>Reusable components and defined tokens that ensure consistency across the platform.',
        imp3Html: '<strong>Foundation for development</strong>The technical team had a clear visual and functional guide to build the platform.',
        imp4Html: '<strong>Scalable platform</strong>A system designed to grow with new sports, formats, and features.',
        impactFinalHtml: '<strong>From idea to screen: flows, interfaces, and a design system that turn a vision into a real product.</strong>',
        ...
        playersnapDesc: 'UX/UI design of an AI-powered SaaS for sports organizations, centralizing the management, analysis, and real-time distribution of multimedia content.<br/>',
        parrotfyTitle: 'Organization and Control for Growing Businesses',
        parrotfyDesc: 'Product design for an SMB-focused ERP that integrates finance, inventory, billing, and project management into a single platform.<br/>',
        bluesphereTitle: 'Cybersecurity Platform for SMBs',
